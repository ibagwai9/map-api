...
DELIMITER $$
CREATE  PROCEDURE `selectTransactions`(IN `user_department` VARCHAR(255), IN `user_role` VARCHAR(255), IN `in_mda_name` VARCHAR(255), IN `user_agent_id` VARCHAR(20), IN `in_from` VARCHAR(20), IN `in_to` VARCHAR(20))
BEGIN
